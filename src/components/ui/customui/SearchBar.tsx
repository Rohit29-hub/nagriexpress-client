...
const SearchBar = () => {
    ...
    return (
        <form action={formAction} className='flex w-auto items-center relative overflow-hidden rounded-full h-full border border-solid dark:border-white'>
            <input
                type='text'
                name='search'
                placeholder='Search NagriExpress'
                className='w-full h-10 md:h-full px-4 dark:text-white text-black bg-white   focus:outline-none'
            />
